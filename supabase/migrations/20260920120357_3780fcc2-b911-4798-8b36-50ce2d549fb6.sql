...
-- Set default organization_id on tables with NOT NULL constraints
...
-- Update handle_new_user() trigger to safely include organization_id
...
-- Update handle_pilot_verification_approval() trigger to supply organization_id
