...
// the real Stripe secret key. Never instantiate Stripe against api.stripe.com
// directly — the env keys here are gateway connection identifiers.
...
// Webhook signature verification (HMAC-SHA256, no SDK needed).
export async function verifyWebhook(
  req: Request,
  env: StripeEnv,
): Promise<{ type: string; data: { object: Record<string, any> } }> {
