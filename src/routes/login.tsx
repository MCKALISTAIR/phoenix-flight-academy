  ...
  head: () => ({
    meta: [
      { title: "Sign in | Phoenix Flight Training" },
      {
        name: "description",
        content:
          "Access the Phoenix Flight online portal. Unified member login and prospective student/renter registration gateway.",
      },
    ],
  }),
});
...
function LoginPage() {
  ...
  async function handleLoginSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const dest =
        search.redirect ??
        (userData.user ? await defaultDestinationFor(userData.user.id) : "/booking/dashboard");
      navigate({ to: dest });
    } catch (err: unknown) {
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        setError(
          "An account with this email already exists. Please sign in using the Sign In tab.",
        );
      } else {
        setError(msg);
      }
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Phoenix Flight Training Online System</p>
              </div>
            </div>
            <div>
              <Link
          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
              ...
              <div className="px-6 py-5">
                <div className="flex items-center gap-3 rounded-lg border border-success/20 bg-success/10 p-3.5 text-success">
                  <div className="h-2.5 w-2.5 rounded-full bg-success ring-2 ring-success/30"></div>
                  <span className="font-mono text-xs font-semibold uppercase tracking-wider">
                    EGPG OPERATIONAL | Cumbernauld flights active
                  </span>
                </div>
              </div>
            </div>
                  ...
                  <div className="text-center py-12 max-w-md mx-auto space-y-6">
                    ...
                    <div>
                      ...
                      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                        ...
                        has been created. A confirmation email has been dispatched to your inbox.
                        Please verify your email, then sign in below to access your portal.
                      </p>
                    </div>
                        ...
                        {registerType === "student" ? (
                          ...
                          <form onSubmit={handleRegisterSubmit} className="space-y-5" noValidate>
                            ...
                            <div>
                              ...
                              >
                                <option value="ppl">
                                  Full Private Pilot License (PPL) - 45 Hours
                                </option>
                                <option value="lapl">
                                  Light Aircraft Pilot License (LAPL) - 30 Hours
                                </option>
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                onChange={(e) =>
                                  setStudentForm({ ...studentForm, message: e.target.value })
                                }
                                className="mt-1.5 block w-full rounded-lg border border-input bg-background px-3.5 py-2.5 shadow-sm focus:border-primary focus:outline-none"
                          ...
                          <form onSubmit={handleRegisterSubmit} className="space-y-5" noValidate>
                            <div className="grid gap-5 sm:grid-cols-2">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setPilotForm({ ...pilotForm, name: e.target.value })
                                  }
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setPilotForm({ ...pilotForm, hours: e.target.value })
                                  }
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setPilotForm({ ...pilotForm, email: e.target.value })
                                }
                            ...
                            <div className="grid gap-5 sm:grid-cols-2">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setPilotForm({ ...pilotForm, password: e.target.value })
                                  }
                                  className={`mt-1.5 block w-full rounded-lg border bg-background px-3.5 py-2.5 shadow-sm text-sm focus:outline-none focus:ring-1 ${formErrors.password ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-input focus:border-primary focus:ring-primary"}`}
                                  placeholder="Min. 8 characters"
                                />
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setPilotForm({ ...pilotForm, confirmPassword: e.target.value })
                                  }
                                  className={`mt-1.5 block w-full rounded-lg border bg-background px-3.5 py-2.5 shadow-sm text-sm focus:outline-none focus:ring-1 ${formErrors.confirmPassword ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-input focus:border-primary focus:ring-primary"}`}
                                  placeholder="Repeat password"
                                />
                            ...
                            <div className="grid gap-5 sm:grid-cols-2">
                              <div>
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    setPilotForm({ ...pilotForm, license: e.target.value })
                                  }
                                  className="mt-1.5 block w-full rounded-lg border border-input bg-background px-3.5 py-2.5 shadow-sm focus:border-primary focus:outline-none"
                                >
                              ...
                              <div>
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    setPilotForm({ ...pilotForm, medical: e.target.value })
                                  }
                                  className="mt-1.5 block w-full rounded-lg border border-input bg-background px-3.5 py-2.5 shadow-sm focus:border-primary focus:outline-none"
                                >
                                  <option value="current">Class 2 Medical - Current</option>
                                  <option value="laplMed">
                                    LAPL Medical Declaration - Current
                                  </option>
                            ...
                            {pilotForm.medical === "lapsed" && (
                              <div className="rounded-lg bg-red-500/10 p-4 border border-red-500/25 animate-in fade-in slide-in-from-top-1 duration-200">
                                <p className="text-xs font-semibold text-red-700 dark:text-red-400 flex items-center gap-1.5">
                                  ...
                                  Warning: Self-hire rentals require a current valid medical.
                                  Phoenix offers contact information for CAA AMEs if you need a
                                  renewal checkout.
                                </p>
                              </div>
                            )}
                            ...
                            <div className="rounded-lg bg-orange-500/10 p-4 border border-orange-500/25">
                              <p className="text-xs leading-relaxed text-orange-800 dark:text-orange-300">
                                <strong>Club Notice:</strong> Renting pilot privileges require a
                                one-hour club checkout flight with a Phoenix instructor. Please
                                bring your paper logbook, license booklet, and active medical sheet
                                when arriving for checkout scheduling.
                              </p>
                            </div>
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-150">
                <div className="relative w-full max-w-md rounded-2xl border border-border bg-card p-6 shadow-2xl">
                  ...
                  <p className="mt-4 text-xs leading-relaxed text-muted-foreground">
                    Enter the email address associated with your flight portal account. We'll send
              ...
              <div className="p-6 space-y-6">
                <div>
                  ...
                  {!showDecoded ? (
                    <div className="mt-2 rounded-lg bg-slate-950 p-3.5 text-xs font-mono text-slate-100 border border-slate-800 leading-relaxed tracking-wide">
                      ...
                      {windSpeed.toString().padStart(2, "0")}KT 9999 FEW030 14/08 Q1012
                    </div>
                  ) : (
                    <div className="mt-2 rounded-lg bg-slate-950 p-3.5 text-xs font-mono text-slate-300 border border-slate-800 space-y-1.5 leading-relaxed">
                      <p>
                        <span className="text-blue-400">WIND:</span> {windDir}° at {windSpeed} knots
                      </p>
                      <p>
                        <span className="text-blue-400">VISIBILITY:</span> 10km+ (Perfect Visual
                        Range)
                      </p>
                      <p>
                        <span className="text-blue-400">CLOUDS:</span> Few Clouds at 3,000 ft
                      </p>
                      <p>
                        <span className="text-blue-400">TEMP/DEW:</span> 14°C / 08°C
                      </p>
                      <p>
                        <span className="text-blue-400">ALTIMETER:</span> QNH 1012 hPa (Standard)
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="rounded-xl bg-slate-950 border border-slate-800 p-4 font-mono text-xs space-y-2.5">
                  <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                    <span className="text-slate-400 text-[10px] tracking-wider uppercase font-bold">
                      EGPG Airfield Status
                    </span>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-slate-300 text-[11px] bg-slate-900/50 p-2 rounded">
                    <div>
                      <span className="block text-slate-500 text-[9px] uppercase font-bold">
                        Headwind
                      </span>
                    ...
                    <div>
                      ...
                      <span
                        className={`font-bold text-sm ${crosswind > 15 ? "text-red-400" : "text-amber-500"}`}
                      >
                        {crosswind} kts
                      </span>
                    </div>
                  ...
                  {crosswind > 15 && (
                    <div className="text-[10px] bg-red-950/40 border border-red-900/30 text-red-400 p-2.5 rounded flex items-start gap-2 leading-relaxed">
                      ...
                      <span>
                        Warning: Crosswinds exceed safe 15 kts limit for student solo circuits. Dual
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
                    Phoenix Flight portals synchronize and protect training records strictly within
                    EASA and CAA data regulations.
                  </p>
                </div>
              </div>
            </div>
