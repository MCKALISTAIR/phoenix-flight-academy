              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <input
                        ...
                        className="block w-24 bg-transparent text-sm font-black text-white outline-none border-b border-transparent focus:border-primary px-0 py-0.5"
                      />
                      <input
                        type="text"
                        value={ac.model}
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg border border-white/10 bg-white/5 text-white/50 hover:bg-white/10 hover:text-white transition-all disabled:opacity-40"
                      title="Save"
                    >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full mt-1 rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-white outline-none focus:border-primary"
                  >
                    {STATUSES.map((s) => (
                      <option key={s.value} value={s.value} className="bg-primary">
                        {s.label}
                      </option>
                    ))}
                  </select>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="rounded-xl border border-white/5 bg-white/3 p-3">
                    ...
                    <input
                      ...
                      className="mt-1 block w-full bg-transparent text-sm font-bold text-white outline-none border-b border-transparent focus:border-primary"
                    />
                  </div>
                  <div className="rounded-xl border border-white/5 bg-white/3 p-3">
                    <div className="flex items-center gap-1.5 text-white/30">
                ...
                <div className="space-y-2 border-t border-white/5 pt-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-white/40">
                    ...
                    <input
                      ...
                      onChange={(e) => update(ac.id, "next_50hr", parseFloat(e.target.value) || 0)}
