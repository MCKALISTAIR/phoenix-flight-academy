...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Privacy policy for Phoenix Flight Training, Cumbernauld Airport.",
      },
    ],
  }),
});
      ...
      <div className="container mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 space-y-10">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Phoenix Flight Training is a UK Civil Aviation Authority (CAA) approved flight training
            organisation based at Cumbernauld Airport, G68 0PR, Scotland. We are committed to
            protecting your personal data in accordance with the UK General Data Protection
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            When you contact us, register for training, or use our booking portal, we may collect:
            your name, email address, phone number, date of birth, medical certificate details,
            pilot licence information, and training history.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            We use your data solely to provide flight training services, maintain regulatory
            compliance with the CAA, manage your training record, and communicate with you about
            your training schedule and progress. We do not sell your data to third parties.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Under UK GDPR, you have the right to access, rectify, erase, and port your data. To
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            For privacy-related enquiries, contact our Data Controller at Phoenix Flight Training,
            Cumbernauld Airport, G68 0PR or by email at{" "}
            <a
              href="mailto:info@phoenixflighttraining.co.uk"
              className="text-primary hover:underline"
            >
